...
export function AddDayPlanForm({
  ...
  const finalConfirmLabel = confirmLabel || t('inlineEditActivity.saveButton');
  const finalDeleteLabel = deleteLabel || t('inlineEditActivity.deleteButton');
  ...
  return (
    <div className="flex flex-col gap-2">
      <input
        ...
        placeholder={t('inlineEditActivity.descriptionPlaceholder')}
      ...
      <div className="flex gap-1.5">
        ...
        >
          {t('inlineEditActivity.cancelButton')}
        </button>
